...
from dataset_prep import BilingualDataset
import torch
import sys
...
def translate(sentence: str):
    ...
    model_filename = "translation_transformer/translation_transformer.pth"
...
translate("My name is Valentine")
